...
Roles
*/
insert into role values ('role_1', now(), null , 'role_1');
insert into role values ('role_2', now(), null , 'role_2');
insert into role values ('role_3', now(), null , 'role_3');
...
user_roles
*/
insert into user_roles values ('id1', 'role_1');
insert into user_roles values ('id2', 'role_2');
insert into user_roles values ('id3', 'role_3');
insert into user_roles values ('id4', 'role_1');
insert into user_roles values ('id5', 'role_2');